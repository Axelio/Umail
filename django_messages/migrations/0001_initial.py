...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Destinatarios'
        db.create_table(u'destinatarios', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('grupos', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.Group'], unique=True, null=True, blank=True)),
            ('usuarios', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.UserProfile'], unique=True, null=True, blank=True)),
        ))
        db.send_create_signal(u'django_messages', ['Destinatarios'])

        # Adding model 'EstadoMemo'
        db.create_table(u'django_messages_estadomemo', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('nombre', self.gf('django.db.models.fields.CharField')(unique=True, max_length=50)),
        ))
        db.send_create_signal(u'django_messages', ['EstadoMemo'])

        # Adding M2M table for field modificable on 'EstadoMemo'
        m2m_table_name = db.shorten_name(u'django_messages_estadomemo_modificable')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('estadomemo', models.ForeignKey(orm[u'django_messages.estadomemo'], null=False)),
            ('group', models.ForeignKey(orm[u'auth.group'], null=False))
        ))
        db.create_unique(m2m_table_name, ['estadomemo_id', 'group_id'])

        # Adding model 'Adjunto'
        db.create_table('adjuntos', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('mensaje', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['django_messages.Message'])),
            ('archivo', self.gf('django.db.models.fields.files.FileField')(max_length=100, null=True, blank=True)),
        ))
        db.send_create_signal(u'django_messages', ['Adjunto'])

        # Adding model 'Message'
        db.create_table(u'django_messages_message', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('recipient', self.gf('django.db.models.fields.related.ForeignKey')(related_name='received_messages', to=orm['django_messages.Destinatarios'])),
            ('con_copia', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('subject', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ('archivo', self.gf('django.db.models.fields.files.FileField')(max_length=100, null=True, blank=True)),
            ('body', self.gf('django.db.models.fields.TextField')()),
            ('sender', self.gf('django.db.models.fields.related.ForeignKey')(related_name='sent_messages', to=orm['django_messages.Destinatarios'])),
            ...
            ('status', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['django_messages.EstadoMemo'], null=True, blank=True)),
            ('tipo', self.gf('django.db.models.fields.CharField')(max_length=10, null=True, blank=True)),
            ('codigo', self.gf('django.db.models.fields.CharField')(max_length=30, null=True, blank=True)),
            ('num_ident', self.gf('django.db.models.fields.BigIntegerField')(null=True, blank=True)),
        ))
        db.send_create_signal(u'django_messages', ['Message'])


    def backwards(self, orm):
        # Deleting model 'Destinatarios'
        db.delete_table(u'destinatarios')

        # Deleting model 'EstadoMemo'
        db.delete_table(u'django_messages_estadomemo')

        # Removing M2M table for field modificable on 'EstadoMemo'
        db.delete_table(db.shorten_name(u'django_messages_estadomemo_modificable'))

        # Deleting model 'Adjunto'
        db.delete_table('adjuntos')
