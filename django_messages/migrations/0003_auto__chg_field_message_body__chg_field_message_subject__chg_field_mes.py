...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'django_messages_message', 'body', self.gf('django.db.models.fields.TextField')(null=True))

        # Changing field 'Message.subject'
        db.alter_column(u'django_messages_message', 'subject', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))

        # Changing field 'Message.recipient'
        db.alter_column(u'django_messages_message', 'recipient_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['django_messages.Destinatarios']))

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'Message.body'
        raise RuntimeError("Cannot reverse this migration. 'Message.body' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration
        # Changing field 'Message.body'
        db.alter_column(u'django_messages_message', 'body', self.gf('django.db.models.fields.TextField')())

        # User chose to not deal with backwards NULL issues for 'Message.subject'
        raise RuntimeError("Cannot reverse this migration. 'Message.subject' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration
        # Changing field 'Message.subject'
        db.alter_column(u'django_messages_message', 'subject', self.gf('django.db.models.fields.CharField')(max_length=255))
        ...
        # The following code is provided here to aid in writing a correct migration
        # Changing field 'Message.recipient'
        db.alter_column(u'django_messages_message', 'recipient_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['django_messages.Destinatarios']))
    ...
    models = {
        ...
        u'django_messages.message': {
            ...
            'archivo': ('django.db.models.fields.files.FileField', [], {'max_length': '100', 'null': 'True', 'blank': 'True'}),
            'body': ('django.db.models.fields.TextField', [], {'default': "'Sin mensaje'", 'null': 'True'}),
            ...
            'recipient': ('django.db.models.fields.related.ForeignKey', [], {'default': "''", 'related_name': "'received_messages'", 'null': 'True', 'blank': 'True', 'to': u"orm['django_messages.Destinatarios']"}),
