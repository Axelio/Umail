...
def menu(seccion):
    ...
    for posicion in range(titulos.__len__()):
        if titulos[posicion] == seccion:
            ...
            activo = ''
        url = '<li class='+ clase[posicion] +' '+ activo +'><a href='+ enlace[posicion] +'>'+ '<cufon class="cufon cufon-canvas" alt="Inicio" style="width: 80px; height: 24px;"><canvas width="88" height="29" style="width: 88px; height: 29px; top: -4px; left: -1px;"/><cufontext>' + titulos[posicion] + '</cufontext></cufon>' +'</a></li>'
